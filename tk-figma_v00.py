...
greeting_text = "Hello! 🙌🏾 \n\n\nA startup for computer science students to build a PC based on your requirements and budget. 💻 👨🏾‍💻"

greeting = tk.Label(root, text=greeting_text, fg="#faf2e9", bg="#32402f", font=("Courier", 12, "bold"), anchor="w", width=60, padx=30, pady=40)
